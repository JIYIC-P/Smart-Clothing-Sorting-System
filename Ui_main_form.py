...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comBox_pusher = QtWidgets.QComboBox(self.tab)
        self.comBox_pusher.setGeometry(QtCore.QRect(1140, 50, 121, 31))
        self.comBox_pusher.setObjectName("comBox_pusher")
        self.comBox_pusher.addItem("")
        self.comBox_pusher.addItem("")
        self.comBox_pusher.addItem("")
        self.comBox_pusher.addItem("")
        self.comBox_pusher.addItem("")
        self.btn_save_colors = QtWidgets.QPushButton(self.tab)
        self.btn_save_colors.setGeometry(QtCore.QRect(1270, 40, 131, 51))
        self.btn_save_colors.setObjectName("btn_save_colors")
        self.txt_hsv = QtWidgets.QTextEdit(self.tab)
        self.txt_hsv.setGeometry(QtCore.QRect(850, 490, 551, 171))
        ...
        self.btn_reset.setGeometry(QtCore.QRect(880, 130, 200, 60))
        ...
        self.btn_start.setGeometry(QtCore.QRect(880, 30, 200, 60))
        ...
        self.comboBox_mode.setGeometry(QtCore.QRect(880, 230, 200, 60))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_mode.addItem("")
        self.comboBox_mode.addItem("")
        self.Hmin_slider = QtWidgets.QSlider(self.tab)
        self.Hmin_slider.setGeometry(QtCore.QRect(1140, 150, 16, 160))
        self.Hmin_slider.setOrientation(QtCore.Qt.Vertical)
        self.Hmin_slider.setObjectName("Hmin_slider")
        self.Smin_slider = QtWidgets.QSlider(self.tab)
        self.Smin_slider.setGeometry(QtCore.QRect(1230, 150, 16, 160))
        self.Smin_slider.setOrientation(QtCore.Qt.Vertical)
        self.Smin_slider.setObjectName("Smin_slider")
        self.Vmin_slider = QtWidgets.QSlider(self.tab)
        self.Vmin_slider.setGeometry(QtCore.QRect(1320, 150, 16, 160))
        self.Vmin_slider.setMaximum(96)
        self.Vmin_slider.setOrientation(QtCore.Qt.Vertical)
        self.Vmin_slider.setObjectName("Vmin_slider")
        self.txt_hsv_2 = QtWidgets.QTextEdit(self.tab)
        self.txt_hsv_2.setGeometry(QtCore.QRect(1120, 320, 261, 151))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Hmax_slider = QtWidgets.QSlider(self.tab)
        self.Hmax_slider.setGeometry(QtCore.QRect(1170, 150, 16, 160))
        self.Hmax_slider.setOrientation(QtCore.Qt.Vertical)
        self.Hmax_slider.setObjectName("Hmax_slider")
        self.Smax_slider = QtWidgets.QSlider(self.tab)
        self.Smax_slider.setGeometry(QtCore.QRect(1260, 150, 16, 160))
        self.Smax_slider.setOrientation(QtCore.Qt.Vertical)
        self.Smax_slider.setObjectName("Smax_slider")
        self.Vmax_slider = QtWidgets.QSlider(self.tab)
        self.Vmax_slider.setGeometry(QtCore.QRect(1350, 150, 16, 160))
        self.Vmax_slider.setOrientation(QtCore.Qt.Vertical)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comBox_pusher.setItemText(0, _translate("Dialog", "推杆1"))
        self.comBox_pusher.setItemText(1, _translate("Dialog", "推杆2"))
        self.comBox_pusher.setItemText(2, _translate("Dialog", "推杆3"))
        self.comBox_pusher.setItemText(3, _translate("Dialog", "推杆4"))
        self.comBox_pusher.setItemText(4, _translate("Dialog", "推杆5"))
        self.btn_save_colors.setText(_translate("Dialog", "应用"))
        ...
        self.Hmin_slider.setToolTip(_translate("Dialog", "Hmin"))
        self.Smin_slider.setToolTip(_translate("Dialog", "Smin"))
        self.Vmin_slider.setToolTip(_translate("Dialog", "Vmin"))
        self.Hmax_slider.setToolTip(_translate("Dialog", "Hmax"))
        self.Smax_slider.setToolTip(_translate("Dialog", "Smax"))
        self.Vmax_slider.setToolTip(_translate("Dialog", "Vmax"))
